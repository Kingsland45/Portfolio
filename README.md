...
# Professional Touch-Screen Kiosk for Employee Scheduling (2025 Build)
This Python project developed by me is currently used by hundreds of employees in a professional logistics corporation (Kroger contracted client). This allows the floor workers to easily and convieniently sign up for extra work on one of our touvhscreen kiosk, all while keeping the control and monitoring in the hands of managers (Admins). This has eliminated countless work hours, cut down our cost, and made the scheduling process a breeze. This is my most feature rich and complete Python project to date and features a beatifure and intuitive GUI for both the admin panel and the employee touchscreen. Data management is key in this application, and it can run flawlessly for an unlimited amount of time thanks to automatic data cleaning features. This is a truely industrial level application that is currently in use by one of the biggest and most vital companies in America today, Kroger. 
...
It also includes a customer management feature for adding, editing, and deleting customer records, with all data securely stored in
